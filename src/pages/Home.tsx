        ...
        <Container maxW="container.xl">
          <VStack spacing={{ base: 8, lg: 12 }} align="center">
            ...
            >
              ...
              FloodGuard, we help you stay prepared through our 3-step approach
            </Text>
                        ...
                        <Box flex={1}>
                          <VStack align="start" spacing={4}>
                            ...
                            <Text color="gray.600">
                              ...
                              planning, land-use regulation, and infrastructure
                              development.
                            </Text>
                            ...
                            <Text color="gray.600">
                              ...
                              evolve, helping shape long-term infrastructure and
                              policy decisions.
                            </Text>
                            <Button
                              colorScheme="blue"
                        ...
                        <Box flex={1}>
                          <VStack align="start" spacing={4}>
                            ...
                            <Text color="gray.600">
                              ...
                              neighbourhoods, apartments, or housing colonies to
                      ...
                      <Flex direction={{ base: "column", md: "row" }} gap={8}>
                        ...
                        <Box flex={1}>
                          <VStack align="start" spacing={4}>
                            ...
                            <Text color="gray.600">
                              Evaluate flood exposure for commercial properties,
                              industrial facilities, and future investment
                              sites.
                            </Text>
                            <Heading size="md" color="#0F2922" mt={4}>
